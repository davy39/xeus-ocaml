let () =
  ...
  Fun.protect
    ...
    (fun () ->
      Printf.fprintf out
        "(* This file is generated by gen_dynamic.ml. DO NOT EDIT. *)\n";
        ...
        let artifact_files =
          Array.fold_left
            (fun acc file ->
              ...
              then file :: acc (* Just add the raw filename to the list. *)
              else acc)
            [] all_files_in_dir
        in
      ...
      with Sys_error _ ->
        Printf.eprintf
          "Warning: 'dynamic/stdlib' directory not found. Generating empty \
           dynamic list.\n\
           %!";
        Printf.fprintf out "]\n")
